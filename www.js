...
for(i = 0; i < arr.length; i++) {
	string = decodeURI(arr[i]);
	request('https://translate.google.ru/translate_tts?ie=UTF-8&q='
	+ string +
	'&tl=en&total=1&idx=0&textlen=14&client=t&prev=input').pipe(
		fs.createWriteStream('lol/' + name++ + '.mp3')
